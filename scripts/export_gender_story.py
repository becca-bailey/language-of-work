...
Per-company careers-register sentences (mission_brand, deduped, first-capture
year), each projected onto the gender axis and z-scored against a FROZEN
baseline: the 20 pre-story companies' pooled sentences — so adding cohort
companies never moves the yardstick. Canon documents are excluded by design
