...
<div class="my-6 rounded-lg border border-amber-300 bg-amber-50 p-4 dark:border-amber-700/60 dark:bg-amber-950/30">
  <p class="text-xs font-medium uppercase tracking-wide text-amber-700 dark:text-amber-500">
    The one verbatim lift
  </p>
  <div class="mt-2 space-y-1 font-mono text-sm">
    <p>
      <span class="text-neutral-500">Netflix 2009: </span>
      <span class="rounded bg-rose-200/60 px-1 dark:bg-rose-900/50">adequate</span> performance gets a
      generous severance package
    </p>
    <p>
      <span class="text-neutral-500">Coinbase 2024: </span>
      <span class="rounded bg-amber-200/70 px-1 dark:bg-amber-800/50">unremarkable</span> performance gets
