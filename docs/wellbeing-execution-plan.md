...
4. **Substitution** — pre/post-2022 individualization index, paired Wilcoxon; 2×2 change-direction × locus via Fisher's exact; Kaplan-Meier survival by locus (flagged exploratory — archival censoring is real).
