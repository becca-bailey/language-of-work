...
function Chart({ data, width }: Props & { width: number }) {
  ...
  return (
    <div className="relative">
      <svg width={width} height={height} role="img" aria-label="How Menlo counts its impact">
      ...
      {tooltipData && (
        ...
        >
          ...
          <p className="mt-0.5 font-mono text-neutral-600 dark:text-neutral-300">
            {tooltipData.value} mention{tooltipData.value === 1 ? "" : "s"}
          </p>
        </TooltipWithBounds>
      )}
    </div>
...
export default function MenloAuditChart(props: Props) {
  return (
    <ParentSize>
